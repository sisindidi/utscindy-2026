...
class ProjectdetailPolicy
{
    ...
    {
        return $user->can('view_any_projectdetail');
    }
    ...
    {
        return $user->can('view_projectdetail');
    }
    ...
    {
        return $user->can('create_projectdetail');
    }
    ...
    {
        return $user->can('update_projectdetail');
    }
    ...
    {
        return $user->can('delete_projectdetail');
    }
    ...
    {
        return $user->can('delete_any_projectdetail');
    }
